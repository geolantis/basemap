...
// Read the existing basemap8.json
const basemap = JSON.parse(fs.readFileSync('/Users/michael/Development/basemap/basemap8.json', 'utf8'));

// HL layers to add on top (from the provided structure)
const hlLayers = [
  {
...
// Update the sprite and glyphs URLs to match the HL layer style
basemap.sprite = "https://mapsneu.wien.gv.at/basemapv/bmapvhl/3857/resources/sprites/sprite";
basemap.glyphs = "https://mapsneu.wien.gv.at/basemapv/bmapvhl/3857/resources/fonts/{fontstack}/{range}.pbf";

// Add HL layers to the end of the layers array (so they render on top)
basemap.layers = basemap.layers.concat(hlLayers);

// Write the modified basemap
fs.writeFileSync('/Users/michael/Development/basemap/basemap8_with_hl.json', JSON.stringify(basemap, null, 2));

console.log('Successfully created basemap8_with_hl.json with HL layers on top');
console.log(`Total layers: ${basemap.layers.length}`);
console.log(`HL layers added: ${hlLayers.length}`);